...
<Prop
            ...
            <Prop
              ...
              misc={
                <>
                  Utility method that shows the layer with a mouse event as it's source.
                </>
              } />
            <Prop
              ...
              misc={
                <>
                  Utility method that shows the layer with a context-menu-event as it's source.
                </>
              } />
            <Prop name="close()" type={<>(): void</>} misc="Hides the layer" />
            <Prop
...
https://codesandbox.io/s/circular-menu-autoadjust-m9zi5
...
https://codesandbox.io/s/nested-context-menus-xx52d
...
https://codesandbox.io/s/color-picker-boxes-853ix

## DraftJS text selection menu

https://codesandbox.io/s/draftjs-text-selection-5ru5r
